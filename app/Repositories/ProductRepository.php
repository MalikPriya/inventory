...
class ProductRepository implements ProductInterface
{
    ...
    public function update($id, array $newDetails)
    {
        ...
        try {
            ...
            $updatedEntry->cost_price = $collectedData['cost_price'];
            $updatedEntry->sell_price = $collectedData['sell_price'];
            $updatedEntry->unit_value = $collectedData['unit_value'];
            $updatedEntry->unit_type = $collectedData['unit_type'];
