                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ request()->input('mobile') }}" required autocomplete="mobile">
