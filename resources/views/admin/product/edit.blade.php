        ...
        <div class="row">
            <div class="col-sm-9">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="cat_id">
                            ...
                            @foreach ($categories as $index => $item)
                                <option value="{{$item->id}}" {{ $data[0]->cat_id ?? ($data[0]->cat_id == $item->id) ? 'selected' : ''}}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="sub_cat_id">
                            ...
                            @foreach ($sub_categories as $index => $item)
                                <option value="{{$item->id}}" {{ ($data[0]->sub_cat_id) ?? ($data[0]->sub_cat_id == $item->id) ? 'selected' : ''  }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    ...
                    {{-- <div class="col-sm-4">
                        <select class="form-control" name="collection_id">
                            ...
                            @foreach ($collections as $index => $item)
                                <option value="{{$item->id}}" {{ ($data[0]->collection_id')) ?? ($data[0]->collection_id') == $item->id) ? 'selected' : ''  }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group mb-3">
                    <input type="text" name="name" placeholder="Add Product Title" class="form-control" value="{{$data[0]->name}}">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <content>
                            ...
                            <div class="col-auto">
                                <input type="number" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="cost_price" value="{{$data[0]->cost_price}}">
                            ...
                            <div class="col-auto">
                                <input type="number" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="sell_price" value="{{$data[0]->sell_price}}">
                        ...
                        <div class="admin__content">
                            ...
                            <content>
                                <div class="row mb-2 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input type="number" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="unit_value" value="{{$data[0]->unit_value}}">
